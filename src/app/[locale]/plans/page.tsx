              ...
              return (
                <div
                  ...
                  className={cn("relative rounded-2xl shadow-lg", {
                    "border-2 border-purple-800 shadow-purple-400":
                      plan === "Pro",
                    "border border-gray-600": plan !== "Pro",
                  })}
                >
                  {plan === "Pro" && (
                  ...
                  <div className="p-5">
                    <h3 className="my-3 text-center front-display text-3xl font-bold">
                      {plan}
                    </h3>
                  ...
                  <div className="flex h-20 items-center justify-center border-b border-t border-gray-800 ">
                    <div className="flex items-center space-x-1">
                      {plan === "Pro" ? (
                        <p>Unlimited reminders included</p>
                      ) : (
                        <p>{quota.toLocaleString()} reminders included</p>
                      )}
